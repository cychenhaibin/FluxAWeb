...
const faqs = [
  ...
  {
    q: "MiniMax Max 拼车是什么？",
    a: "Anthropic Claude Max 5x ($100/账号) 官方团队账号 2-4 人拼车共享。2 人 ¥60/月、3 人 ¥89/月、4 人 ¥119/月（推荐价，人均 ¥30），无服务费，比单独订阅省 50% 以上。Sonnet 4.5 + Opus 4.1 全模型 / Opus 4 优先 / 高峰不限速等官方全部功能保留。",
  },
  {
    q: "5 分钟到账是真的吗？",
